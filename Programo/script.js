...
elementList.firstElementChild.textContent = 'Primer elemento';
...
elementList.lastElementChild.textContent = 'último elemento';
...
// let tsuru = { color: 'black', type: 'sedan', year: '2019' };
// console.info('tsuru: ' + tsuru);
// console.info('tsuru: ', tsuru);


// localStorage.setItem("session", JSON.stringify(tsuru));
...
// sessionStorage.removeItem("nombre");                      //elimin